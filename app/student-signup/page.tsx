              ...
              <form onSubmit={handleSignUp} className="space-y-5">
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    className="mt-1 w-4 h-4 rounded border-white/20 bg-[#16162a] accent-[#B76E79]"
                  />
            ...
            <div className="space-y-8 text-center">
              ...
              <div>
                ...
                <p className="text-white/60">
                  ...
                  <span className="text-white">{email.trim()}</span>. Verify your
              ...
              <a
                href="/student-signin"
                className="inline-block px-8 py-3 bg-[#B76E79] text-white font-semibold rounded-xl hover:bg-[#a05f69] transition-colors"
              >
                Go to Sign In
              </a>
            </div>
          ...
          {view === 'accountExists' && (
            <div className="space-y-8 text-center">
              ...
              <div>
                ...
                <p className="text-white/60">
                  An account with <span className="text-white">{email.trim()}</span>{' '}
