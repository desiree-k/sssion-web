    ...
    <div className="min-h-screen flex flex-col bg-[#0E0E12]">
      ...
      <main className="flex-1 py-12 px-6">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-[#F4F1EA] mb-2">Report content</h1>
          <p className="text-[#F4F1EA]/60 leading-relaxed mb-8">
            See something that breaks our{' '}
            <a href="/content-policy" className="text-[#C9A96A] hover:underline">Content Policy</a>?
