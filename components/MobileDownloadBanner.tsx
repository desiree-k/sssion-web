    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      <div className="mx-3 mb-3 flex items-center justify-between gap-3 bg-[#111120] border border-white/15 rounded-2xl px-4 py-3 shadow-2xl shadow-black/60">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 bg-[#F4F1EA]/10 rounded-xl flex items-center justify-center shrink-0">
            <svg className="w-5 h-5 text-[#F4F1EA]" viewBox="0 0 24 24" fill="currentColor">
